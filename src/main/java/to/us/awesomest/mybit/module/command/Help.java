...
import to.us.awesomest.mybit.MyBit;
import to.us.awesomest.mybit.data.ShortcutData;
...
public class Help implements Command {
    ...
    public void run(User author, MessageChannel channel, @Nullable String args, @NotNull Guild guild) {
        ...
        commandListBuilder
                ...
                .setTitle("Commands")
                .setDescription("The official commands for MyBit.")
                .setFooter("MyBit " + MyBit.getVersion() + " by AwesomestGamer#4703");
